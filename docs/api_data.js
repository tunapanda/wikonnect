define({ "api": [
  {
    "type": "get",
    "url": "/api/v1/accounts-following",
    "title": "GET all accounts user follows",
    "name": "GET_all_accounts_user_follows",
    "group": "Accounts_Following",
    "permission": [
      {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "accountsFollowing[userId]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "accountsFollowing[followingId]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "accountsFollowing[createdAt]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "accountsFollowing[updatedAt]",
    ...
    "filename": "server/routes/accounts-following.js",
    "groupTitle": "Accounts_Following",
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/accounts-following"
      }
    ]
  },
  {
  ...
  {
    "type": "delete",
    "url": "/api/v1/accounts-following/:id",
    ...
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/accounts-following/:id"
      }
    ]
  },
  {
  ...
  {
    "type": "delete",
    "url": "/api/v1/courses-enrolled/:id",
    ...
    "filename": "server/routes/courses-enrolled.js",
    "groupTitle": "Courses_Enrolled",
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/courses-enrolled/:id"
      }
    ]
  },
  {
    ...
    "title": "GET all user course enrollments",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "coursesEnrolled[courseId]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "coursesEnrolled[createdAt]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "coursesEnrolled[updatedAt]",
    ...
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/courses-enrolled"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "server/routes/tags-following.js",
    "groupTitle": "Tags_Following",
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/tags-following/:id"
      }
    ]
  },
  {
    "type": "get",
    "url": "/api/v1/tags-following",
    "title": "GET all tags user follows",
    "name": "GET_all_tags_user_follows",
    "group": "Tags_Following",
    "permission": [
      {
        "name": "authenticated user"
    ...
    "sampleRequest": [
      {
        "url": "https://app.wikonnect.org/api/v1/tags-following"
      }
    ]
  },
  {
